...
<body>
    ...
    <style>
        ...
        .analytics-section,.activity-schedule-section,.quick-stats-section,.my-schedule-section{
            width:100%;
            display:block;
            margin-bottom:20px;
            background:#800000;
        ...
        .section-header h2{display:flex;gap:10px;align-items:center;justify-content:center;margin:0 0 6px 0;color:#ffffff;font-size:1.8rem;font-weight:700}
        .section-header p{color:#e0e0e0;font-size:1rem;margin:0}
        ...
        .chart-card,.activities-card,.clients-card{background:#fff;border-radius:16px;padding:24px;box-shadow:0 4px 20px rgba(0,0,0,.08);border:1px solid #f0f0f0}
        .my-schedule-section .schedules-card{background:rgba(255,255,255,.95);border-radius:12px;padding:24px;box-shadow:0 2px 10px rgba(0,0,0,.15);border:1px solid rgba(255,255,255,.2)}
        ...
        .empty-state{text-align:center;padding:40px 20px;color:rgba(255,255,255,.8)}
