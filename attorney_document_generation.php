...
<body>
    <button class="page-hamburger" id="pageHamburger" aria-label="Toggle menu">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (mainHeader && !mainHeader.contains(hamburger)) {
    ...
    <style>
        ...
        .page-hamburger {
            ...
            padding: 8px 12px;
            cursor: pointer;
            box-shadow: 0 6px 18px rgba(93, 14, 38, 0.25);
